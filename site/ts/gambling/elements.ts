...
export const bjWagerSlider: HTMLInputElement = document.querySelector("#bj-wager-slider")!;

export const bjDealButton = document.getElementById("bj-deal")!;

export const bjWagerDialog: HTMLDialogElement = document.querySelector("#bj-wager-menu")!;
